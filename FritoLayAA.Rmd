...
#####GitHub repository link: <https://github.com/nassenza/Frito-Lay-Attrition-AA>
...
###Execution of Model and Results
...
TrainingSet = read.csv("C:/Users/ASUSL/OneDrive/Desktop/Casestudy2-data.csv")

testSalarySet = read.csv("C:/Users/ASUSL/OneDrive/Desktop/CaseStudy2CompSetNoSalary.csv")

testAttritionSet = read.csv("C:/Users/ASUSL/OneDrive/Desktop/CaseStudy2CompSetNoAttrition.csv") 
employeeCompSet = read.csv(file = "C:/Users/ASUSL/OneDrive/Desktop/CaseStudy2CompSetNoAttrition.csv", header = TRUE, sep = ",")
dim(employeeCompSet)
...
# write to csv file for classifying dataset for the "Competition Set" on Attrition#write.csv(classifyemployeeCompSet, file = "Case2PredictionsAttrition.csv", row.names=FALSE)
```
...
MonthlyIncomeCompSet = read.csv(file = "C:/Users/ASUSL/OneDrive/Desktop/CaseStudy2CompSetNoSalary.csv", header = TRUE, sep = ",")
...
write.csv(predictMonthlyIncomeCompSet, file = "Case2PredictionsSalary.csv", row.names=FALSE)
